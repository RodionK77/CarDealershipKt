...
@Entity
data class CarItem (@PrimaryKey val index: Int, val brand: String, val name: String, val price: Int,
                    ...
                    val height: Int, val trunk: Int, val fuel_tank: Int, val image: String, val top: Int)